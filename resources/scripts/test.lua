...
local function foo()
	...
	inputManager:registerKeys({KeyCode.UP, KeyCode.DOWN, KeyCode.LEFT, KeyCode.RIGHT, KeyCode.LSHIFT, KeyCode.RSHIFT, KeyCode.LCTRL, KeyCode.RCTRL, KeyCode.SPACE, KeyCode.BACKSPACE, 
